...
import com.puglielli.cursomc.domain.ItemPedido;
import com.puglielli.cursomc.domain.Pagamento;
import com.puglielli.cursomc.domain.PagamentoComBoleto;
import com.puglielli.cursomc.domain.PagamentoComCartao;
...
import com.puglielli.cursomc.repositories.CidadeRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "puglielli14@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123") );
		cli1.getTelefones().addAll(Arrays.asList("27363323", "938388393"));
		
		Cliente cli2 = new Cliente(null, "Luciana Puglielli", "sony_ps3@hotmail.com.br", "01234567890", TipoCliente.PESSOAFISICA, pe.encode("123") );
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("27403323", "985388393"));
